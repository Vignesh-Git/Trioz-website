...
const DEMO_DATA = [
  {
    ...
    content:
  "This place is exactly like the picture posted on Trioz Boutique. Great service, we had a great stay!",
  },
  {
    id: 2,
...
const SectionClientSay: FC<SectionClientSayProps> = ({
  ...
  <Heading desc="Let's see what people think of Trioz Boutique" isCenter>
